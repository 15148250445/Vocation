$(function(){
		...
		//二级菜单
		$('.group .groupTop').click(function(){
			if($(this).next('#groupBottom').css('display')!='block'){
				$(this).next('#groupBottom').slideDown(500);
				$(this).siblings().next('#groupBottom').slideUp(500);
			}else{
				$(this).next('#groupBottom').slideUp(500);
			}
		});
